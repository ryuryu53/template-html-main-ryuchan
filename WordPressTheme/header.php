              ...
              <div class="sp-nav__left-content">
                ...
                <ul class="sp-nav__left-items">
                  <li class="sp-nav__left-item">
                    ...
                    <ul class="sp-nav__left-detail-items">
                      <li class="sp-nav__left-detail-item">
                        <a href="<?php echo $information; ?>?tab=panel-1" class="sp-nav__left-detail-link">ライセンス講習</a>
                      </li>
                      <li class="sp-nav__left-detail-item">
                        <a href="<?php echo $information; ?>?tab=panel-3" class="sp-nav__left-detail-link">体験ダイビング</a>
                      </li>
                      <li class="sp-nav__left-detail-item">
                        <a href="<?php echo $information; ?>?tab=panel-2" class="sp-nav__left-detail-link">ファンダイビング</a>
                      </li>
                    </ul>
                  </li>
                  <li class="sp-nav__left-item">
