                ...
                <div class="contact__access">
                  <div class="contact__access-details access-details">
                    <ul class="access-details__items text">
                      ...
                      <li class="access-details__item"><span>TEL:</span><a href="tel:01200000000">0120-000-0000</a></li>
          ...
          <div class="footer-nav__left-content">
            ...
            <ul class="footer-nav__left-items">
              <li class="footer-nav__left-item">
                ...
                <ul class="footer-nav__left-detail-items">
                  <li class="footer-nav__left-detail-item">
                    <a href="<?php echo $information; ?>?tab=panel-1" class="footer-nav__left-detail-link">ライセンス講習</a>
                  </li>
                  <li class="footer-nav__left-detail-item">
                    <a href="<?php echo $information; ?>?tab=panel-3" class="footer-nav__left-detail-link">体験ダイビング</a>
                  </li>
                  <li class="footer-nav__left-detail-item">
                    <a href="<?php echo $information; ?>?tab=panel-2" class="footer-nav__left-detail-link">ファンダイビング</a>
                  </li>
                </ul>
              </li>
              <li class="footer-nav__left-item">
